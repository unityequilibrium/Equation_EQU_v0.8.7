...
The UET Framework is exhaustively verified across 20 physics domains, resolving 10+ major anomalies (Hubble, Proton Radius, g-2, Dark Matter) with a **single mechanism**.

*[View All Experiments](topics/)* | *[Run Tests](topics/run_all_tests.py)*
