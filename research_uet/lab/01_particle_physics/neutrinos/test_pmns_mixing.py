"""
UET Neutrino Mixing (PMNS) Test
================================
Validates UET predictions against PMNS matrix measurements.

PMNS describes: ν_e, ν_μ, ν_τ ↔ ν₁, ν₂, ν₃ mixing

CRITICAL: NO PARAMETER FIXING POLICY
All UET parameters are FREE - derived from first principles only!

Data: PDG 2024, T2K, NOvA, Daya Bay, NuFIT 2024
"""
