"""
Comparison Test: Navier-Stokes vs UET
=====================================
Head-to-head comparison of NS and UET solvers on the same problems.

This is Phase 3 of the research roadmap.
"""
...
def run_all_comparisons():
    ...
    # Save results
    result_dir = Path(__file__).parent.parent.parent / "Result" / "comparison"
